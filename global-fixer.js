...
(function () {
  ...
  function fixContactLayout() {
    ...
    injectCSS('maquinasa-contact-layout', [
      ...
      '  margin: 0 !important;',
      '}',
      // Mapa debajo a (casi) ancho completo
      '.image-location {',
      ...
      '  display: block;',
      '}',
      // Boton WhatsApp dentro de contacts-content-wrapper, al final centrado
