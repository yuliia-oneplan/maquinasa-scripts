...
(function () {
  ...
  function fixHomeStyling() {
    ...
    injectCSS('maquinasa-home-styling', [
      ...
      '    display: block !important;',
      '  }',
      // Simbolo amarillo delante de cada item del submenu
      '  .maquinasa-custom-menu-item::before {',
      '    content: "\\25C6" !important;', // diamante relleno
      '    color: #ffbe40 !important;',
      ...
      '  .maquinasa-custom-menu-item:active {',
      '    color: #204e51 !important;',
